...
class AdminFormatting
{
    ...
    public static function reviewIssueLabel(string $code): string
    {
        return match ($code) {
            ...
            'plan_unmatched' => 'Product rules fired but no plan matched',
            'unwell_no_plan' => 'Pet looks imbalanced but no plan was selected',
    ...
    public static function reviewIssueExplanation(string $code): string
    {
        return match ($code) {
            ...
            'plan_unmatched' => "The pet's results triggered one or more product rules, but no plan's conditions fully matched, so no plan was auto-selected. Review the results and choose a suitable plan manually (or adjust the trigger rules).",
            'unwell_no_plan' => "This pet's results show an imbalance, but none of the current plan rules matched it, so no plan was auto-selected. Review the results and choose an appropriate plan manually before publishing.",
